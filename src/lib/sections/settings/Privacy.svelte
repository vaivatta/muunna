				...
				<div class="flex flex-col gap-4">
					<div class="flex flex-col gap-2">
						<p class="text-base font-bold">
							{m["settings.privacy.fathom_title"]()}
						</p>
						<p class="text-sm text-muted font-normal">
							{@html sanitize(link(
								["fathom_link"],
								m["settings.privacy.fathom_description"](),
								["https://usefathom.com/"],
								[true],
							))}
						</p>
					...
					<div class="flex flex-col gap-3 w-full">
						<div class="flex gap-3 w-full">
							<button
								onclick={() => (settings.fathom = true)}
								class="btn {$effects
									? ''
									: '!scale-100'} {settings.fathom
									? 'selected'
